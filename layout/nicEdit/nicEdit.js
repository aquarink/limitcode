...
var nicEditorConfig = bkClass.extend({
	...
	iconsPath : baseurl + 'layout/nicEdit/nicEditorIcons.gif',
...
var nicLinkButton = nicEditorAdvancedButton.extend({	
	...
	submit : function(e) {
		...
		var title3 = this.inputs['title'].value;
		...
		if(this.ln) {
			this.ln.setAttributes({
				href : withindex+'u?r='+this.inputs['href'].value,
...
var nicUploadButton = nicEditorAdvancedButton.extend({	
	nicURI : withindex + 'article/uploadimage',

					...
					<div class="single-post-box">
						...
						<div class="post-content">
							...
							<video width="100%" height="400px" controls>
							  ...
							  <source src="<?php echo base_url().$detail->video; ?>" type="video/ogg">
							...
							<div class="tab-content">
								...
								<div class="tab-pane active" id="about-autor">
									...
									<div class="autor-box">
										...
										<img class="img img-responsive" src="<?php echo base_url().$authorPhoto; ?>" alt="<?php echo ucwords($authorName); ?>">

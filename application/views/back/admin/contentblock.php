				...
				<table class="table table-hover table-bordered table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-left"><?php if($content['stat'] == 0) { echo '<span style=color:#d9831f>Waiting Approval</span>'; } elseif($content['stat'] == 3) {echo "<span style=color:#ff131e>Blocked</span>";}  ?></td>
							...
							<td class="text-center">
								<div class="dropdown">
									...
									<ul class="dropdown-menu dropdown-menu-right">
										...
										<li><a href="<?php echo base_url().index_with(); ?>approval/unblock/<?php echo $id; ?>"><span class="icon icon-unlock"></span> Unblock</a></li>

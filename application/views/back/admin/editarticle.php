								...
								<form class="form form-horizontal" action="" method="POST" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="form-control childmenu custom-select custom-select-lg" name="childmenu">
												...
												<?php if($row->id_sub == $v->sub) { ?>
												<option selected value="<?php echo $row->id_menu;?>"><?php echo ucfirst($row->sub_name);?></option>
												
												<?php } else { ?>

												<option value="<?php echo $row->id_menu;?>"><?php echo ucfirst($row->sub_name);?></option>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<br>
											<br>
											<input type="hidden" name="thumbnailarticleOri" value="<?php echo $v->thumbnail; ?>">

											<img id="blah" src="<?php echo base_url().$v->thumbnail; ?>" alt="Chose your thumbnil" style="width: 265px"/>
											<p class="help-block">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<button name="submit" value="updatearticle" type="submit" class="btn btn-default"> Update</button>
										</div>
									</div>
								</form>
							</div>
